...
function Capstone() {
  ...
  return (
    <>
      {loading ? (
        <div
          className="capstone-loader-container"
        ...
        <div className="capstone-container-portfolio">
          <div className="capstone-text-container">
            <h1 className="capstone-heading">Capstone</h1>
            <h3 className="capstone-subheading">
              During my final year at university I was put into a group where we
              had to build a specific project based on our strengths for a
              client outside of the university. We chose to build an app using
              Flutter and Dart - which were Googles new languages for app
              development very similar to Apples app development program, Swift,
              but mixed in with elements of the React Javascript framework.
            </h3>
            <h3 className="capstone-subheading">
              For our project we built a mobile app for the Head of Respiratory
              at Sir Charles Gardiner Hospital in Perth, and his patients. The
              app would be downloaded by the patients, or be used at the clinic
              on their devices as a way to capture information without the need
              of paperwork and the mental strain of "filling forms". The mobile
              app was also linked to a web app, which the doctor could access on
              their computer and use to send reminders and calendar events to
              the patients via the mobile app, and also keep track of their
              current medical plan within the scope of care for that
              facility(e.g. respiratory health).
            </h3>
          </div>
          ...
          <div className="capstone-text-container">
            <h3 className="capstone-end">
              This project also included a full presentation of both the mobile
              app and web app, and also a full run down of the testing manual
              and user manual which we created.
            </h3>
          </div>
        </div>
      )}
